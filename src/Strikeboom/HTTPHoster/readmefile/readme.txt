...
Note: If firewall asks for security clearance it's because hosting a server of any kind needs Windows firewall access

How to use your files:
on your web browser go to [your ip]:[port in port.txt]/path/to/your/file
or go to [your ip]:[port in port.txt] and navigate through landing page
